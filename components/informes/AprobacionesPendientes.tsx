...
export function AprobacionesPendientes({ cumplimientos, objetivosMap, userId }: AprobacionesPendientesProps) {
  ...
  const pendientes = cumplimientos.filter(c => !procesados.has(c.id))
