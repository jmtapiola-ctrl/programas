...
## Baseline del Sr — movimientos que el Sr estimó para esta línea (REFERENCIA, NO copiar)

El Sr estimó ${movs.length} movimientos para esta línea. NO son tu inventario —
...
` : ''
  ...
  return `
## Contexto heredado del Plan Sr (propósito/criterios de la línea — DADO, no se redefine)
...
MÉTRICAS de la línea (que figuran arriba en el bloque "Propósito") — esas métricas
